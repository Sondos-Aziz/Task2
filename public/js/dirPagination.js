...
// See https://github.com/michaelbromley/angularUtils/issues/400
    ...
    function dirPaginationControlsTemplateInstaller($templateCache) {
        $templateCache.put('angularUtils.directives.dirPagination.template',
            ...
            '<a href="" ng-click="setCurrent(1)">الأول</a></li>' +
            '' +
            '<li style=" color: black;\n' +
            '  float: left;\n' +
            '  padding: 8px 16px;\n' +
            ...
            ' ng-class="{ disabled : pagination.current == 1 }">' +
            '<a href="" ng-click="setCurrent(pagination.current - 1)">السابق</a></li>' +
            ...
            '<a href="" ng-click="setCurrent(pagination.current + 1)">التالي</a></li>' +
            '<li style="color: black;\n' +
            '  float: left;\n' +
            '  padding: 8px 16px;\n' +
            '  text-decoration: none;\n' +
            '  transition: background-color .3s;\n' +
            '  border: 1px solid #ddd;" ng-if="boundaryLinks"  ng-class="{ disabled : pagination.current == pagination.last }"><a href="" ng-click="setCurrent(pagination.last)">الأخير</a></li></ul>');
    }
